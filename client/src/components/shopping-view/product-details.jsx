...
import { useShopReviewStore } from "@/store/shop-review-store";
...
function ProductDetailsDialog({ open, setOpen, productDetails }) {
  ...
  const { reviews, addReview, getReviews } = useShopReviewStore();
  const { setProductDetails } = useShopProductsStore();
